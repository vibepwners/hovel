...
typedef int (*sq_frame_sink)(void *ctx, UINT16 kind, UINT64 stream_id,
...
BOOL sq_frame_encode(UINT16 kind, UINT64 stream_id, const BYTE *payload,
                     UINT32 length, BYTE **out, UINT32 *out_len);
