...
API4(HANDLE, "kernel32.dll", CreateEventA, LPSECURITY_ATTRIBUTES, BOOL, BOOL, LPCSTR)
...
API2(BOOL, "kernel32.dll", FileTimeToSystemTime, const FILETIME *, SYSTEMTIME *)
...
API1V("kernel32.dll", GetSystemTimeAsFileTime, FILETIME *)
...
API1(BOOL, "kernel32.dll", QueryPerformanceCounter, LARGE_INTEGER *)
API1(BOOL, "kernel32.dll", QueryPerformanceFrequency, LARGE_INTEGER *)
...
API4(LPVOID, "kernel32.dll", HeapReAlloc, HANDLE, DWORD, LPVOID, SIZE_T)
...
API3(BOOL, "advapi32.dll", CryptGenRandom, HCRYPTPROV, DWORD, BYTE *)
