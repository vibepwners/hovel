...
An artifact is any file-like result generated by a run, module, service, or provider.
...
Resolved payload bytes should be persisted as artifacts or otherwise hash-tracked before module execution when practical. This makes runs replay-inspectable without requiring Hovel to understand the payload internals.
