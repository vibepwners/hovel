...
4. Modules run as bounded processes or built-in implementations.
...
+--------------+ | Application  | +--------------+
 ...
 | and builtins | | sessions    | | credentials  |
 +--------------+ +-------------+ +--------------+
```
...
3. Whether REST ships in the first alpha or follows the CLI and TUI.
4. Whether service processes and module processes share one protocol.
5. How much provider state is persisted versus run-scoped.
6. Which isolation mechanisms are required beyond process supervision and Python dependency isolation.
